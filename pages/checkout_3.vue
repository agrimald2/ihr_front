<template>
 <div class="flex flex-col justify-center items-center mt-8 mb-8">
  ...
  <div
    ...
    <CartPageContent v-if="tab.label =='SHOPPING CART'"/>
  </div>
 </div>
</template>
